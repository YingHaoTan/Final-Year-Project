...
public class BrokerRunner
{
  ...
  public void processCmdLine (String[] args)
  {
    ...
    OptionSpec<Integer> backendPortNumberOption = parser.accepts("port").withRequiredArg()
    ...
    try {
      // process broker options
    	cliProps.setProperty("extreme.agent.backendPortNumber", options.valueOf(backendPortNumberOption));
