...
public class TariffConstants {
	public final static List<PowerType> POWER_TYPE_LIST = Arrays.asList(PowerType.BATTERY_STORAGE, PowerType.CHP_PRODUCTION, PowerType.CONSUMPTION, PowerType.ELECTRIC_VEHICLE,
	...
	public final static int MAX_NUM_TARIFF = 5;
}
